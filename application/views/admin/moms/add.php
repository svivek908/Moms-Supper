                    ...
                    <form action="<?php echo current_url();?>" role="form" name="Member_form" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="option_1" class="form-control" id="option_1" value="<?php echo set_value('option_1');?>" autocomplete ="off">
                                <span class="text-danger"><?php echo form_error('option_1');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 2</label>
                                <input type="text" name="option_2" class="form-control" id="option_2" value="<?php echo set_value('option_2');?>" autocomplete ="off">
                                <span class="text-danger"><?php echo form_error('option_2');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 3</label>
                                <input type="text" name="option_3" class="form-control" id="option_3" value="<?php echo set_value('option_3');?>" autocomplete ="off">
                                <span class="text-danger"><?php //echo form_error('option_3');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 4</label>
                                <input type="text" name="option_4" class="form-control" id="option_4" value="<?php echo set_value('option_4');?>" autocomplete ="off">
