...
<div class="content-wrapper" id="changecontent">
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        <div class="inner">
                            <h3><?php
                             echo (isset($total_mom) && $total_mom > 0) ? $total_mom : 0 ; ?>
                            </h3>
                            <p>Total Moms</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-success">
                        <div class="inner">
                            <h3><?php
                                echo (isset($active_mom) && $active_mom > 0) ? $active_mom : 0 ;
                                ?>
                                <!-- <sup style="font-size: 20px">%</sup> -->
                            </h3>
                            <p>Total Active Moms</p>
                        </div>
                        <div class="icon">
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        <div class="inner">
                            <h3><?php
                            echo (isset($inactive_mom) && $inactive_mom > 0) ? $inactive_mom : 0 ;?>
                            </h3>
                            <p>Total Inactive Moms</p>
                        </div>
                        <div class="icon">
