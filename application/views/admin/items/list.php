            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="#Add_item" class="btn btn-success" data-url="" onclick ="all_open('<?php echo base_url('Msa-Item_get_page/add');?>')"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Item</a>
        ...
        <script language="JavaScript" type="text/javascript">
            ...
            $(document).ready(function() {
                $('#datatable').DataTable( {
                    ...
                    "ajax": {
                        "url": "<?php echo base_url('Msa-Items_list')?>",
                        "type": "POST"
                    },
