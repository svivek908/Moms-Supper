                    ...
                    <form action="<?php echo current_url();?>" role="form" name="Member_form" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="option_1" class="form-control" id="option_1" value="<?= $questions->option_1;?>">
                                <span class="text-danger"><?php echo form_error('option_1');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 2</label>
                                <input type="text" name="option_2" class="form-control" id="option_2" value="<?= $questions->option_2;?>">
                                <span class="text-danger"><?php echo form_error('option_2');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 3</label>
                                <input type="text" name="option_3" class="form-control" id="option_3" value="<?= $questions->option_3;?>">
                                <span class="text-danger"><?php echo form_error('option_3');?></span>
                            </div>

                            <div class="form-group">
                                <label for="title">Option 4</label>
                                <input type="text" name="option_4" class="form-control" id="option_4" value="<?= $questions->option_4;?>">
